...
def evaluate_triplet(triplet, target, my_model, emb_ent, emb_rel, full_graph_neg = True):
    """
...
def evaluate_mc(my_model, target, init_emb_ent_samples, init_emb_rel_samples, relation_triplets_samples, full_graph_neg = True):
    """
